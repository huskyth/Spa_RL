...
tokenizer = AutoTokenizer.from_pretrained("ckpt/llama3b_webshop_sft_loramerged", trust_remote_code=True)
# 处理 Llama 无 pad_token 问题
if tokenizer.pad_token is None:
    tokenizer.pad_token = '<|reserved_special_token_0|>'
tokenizer.model_max_length = max_length
base_model = AutoModelForCausalLM.from_pretrained("ckpt/llama3b_webshop_sft_loramerged", trust_remote_code=True, torch_dtype=torch.bfloat16)
...
model_save_path = "ckpt/llama3b_webshop_prm"
